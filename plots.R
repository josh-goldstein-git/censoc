...
p <- ggplot(all_data %>% filter(matched==1, income>0, income<30000, age <=30, age>=25)) + 
  geom_density(position="stack", alpha=1, adjust =1.9, aes(x = educ, fill = "Matched")) +
...
educ_25_30 <- print(p)
save(educ_25_30, file = "./fig/educ_25_30.RData")
